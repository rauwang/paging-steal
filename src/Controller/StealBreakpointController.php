...
class StealBreakpointController
{
    ...
    public function findLastCreateBreakpoint(int $targetId, int $generation) : StealBreakpoint {
        return self::$stealBreakpointClass::findLastCreateBreakpoint($targetId, $generation);
    }
}
